...
export const READY_PROGRAMS: readonly ReadyProgramDefinition[] = [
  {
    ...
    description: "Мини-игра о двух путях к круизу и финальный вопрос, который помогает увидеть силу плана.",
    badge: "Без дедлайна",
    taskCount: 1,
    tasks: [
      {
        title: "Мечта с планом",
        description: "Пройди интерактивную игру «Круиз: сама или через клуб?», сравни два пути к мечте и ответь на финальный вопрос.",
        maxPoints: 5,
